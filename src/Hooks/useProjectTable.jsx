    ...
    const rows = [
        createData('#11231',
            <div className='d-flex justify-content-md-start justify-content-center'>
                <img src={LogoAdobe} /><span className='d-none d-md-inline' style={{ marginLeft: "5px" }}>Chakra Soft UI Version</span>
            </div>,
            "$14,000",
        ...
        createData('#11231',
            <div className='d-flex justify-content-md-start justify-content-center'>
                ...
                <span className='d-none d-md-inline' style={{ marginLeft: "5px" }}>Launch our Mobile App</span>
            </div>, "$5000",
            <div style={{ fontSize: "16px" }}>
                <span style={{
                    background: "#FAFF00",
        ...
        createData('#11231',
            <div className='d-flex justify-content-md-start justify-content-center'>
                <img src={LogoFix} alt="" />
                <span className='d-none d-md-inline' style={{ marginLeft: "5px" }}>Fix Platform Errors</span>
            </div>, "$3500",
            <div style={{ fontSize: "16px" }}>
                <span style={{
                    background: "#7DB00E",
        ...
        createData('#11231',
            <div className='d-flex justify-content-md-start justify-content-center'>
                <img src={LogoAdobe} />
                <span className='d-none d-md-inline' style={{ marginLeft: "5px" }}>Chakra Soft UI Version</span>
            </div>, "$400",
            <div style={{ fontSize: "16px" }}>
                <span style={{
                    background: "#7DB00E",
